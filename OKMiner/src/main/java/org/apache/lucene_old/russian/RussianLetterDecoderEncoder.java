...
import org.apache.lucene_old.LetterDecoderEncoder;
import org.apache.lucene_old.SuffixToLongException;
import org.apache.lucene_old.WrongCharaterException;
...
public class RussianLetterDecoderEncoder implements LetterDecoderEncoder {
    ...
    public Integer encode(String string) {
        ...
        for (int i = 0; i < string.length(); i++) {
            ...
            if (c < 0 || c > 33)
                throw new WrongCharaterException("Symbol " + string.charAt(i) + " is not small cyrillic letter");
            result = result * 34 + c;
        }
